    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Adverteren op nukk.nl</h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Bereik een bewust en kritisch publiek met premium advertenties. 
            Onze WeTransfer-style wallpaper ads bieden maximale impact zonder de gebruikerservaring te verstoren.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Premium Bereik</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Adverteer voor een hoogopgeleid publiek dat waarde hecht aan 
                objectieve informatie en kritisch denken.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Full-Screen Impact</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Onze wallpaper ads vullen het hele scherm voor maximale 
                aandacht, met respectvolle skip-opties.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Transparante Metrics</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Real-time dashboard met impressies, clicks, en engagement 
                metrics voor volledige transparantie.
              </p>
            </CardContent>
          </Card>
        </div>
